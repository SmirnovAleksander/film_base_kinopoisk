            ...
            for script in self.soup.find_all('script', type='application/ld+json'):
                ...
                for node in nodes:
                    ...
                    if number_of_episodes is not None:
                        result['number_of_episodes'] = int(number_of_episodes) if isinstance(number_of_episodes, (int, str)) and str(number_of_episodes).isdigit() else str(number_of_episodes)
